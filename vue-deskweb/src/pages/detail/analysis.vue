  ...
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <v-selection :selections="buyTypes" @onChange="onParamChange('buyType', $event)"></v-selection>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
    ...
    <my-dialog :isShow="isShowPayDialog" @clickClose="hidePayDialog">
      ...
      <bank-chooser @onChange="onChangeBanks"></bank-chooser>
      <div class="button buy-dialog-btn" @click="confirmBuy">
        确认购买
      </div>
    </my-dialog>
    <my-dialog :isShow="isShowErrDialog" @clickClose="hideErrDialog">
      支付失败！
    </my-dialog>
...
<script type="text/ecmascript-6">
  ...
  export default {
    components: {
      VSelection, VChooser, VMulChooser, VCounter, myDialog: Dialog, BankChooser, CheckOrder
    },
    data () {
      return {
        buyNum: 0,
